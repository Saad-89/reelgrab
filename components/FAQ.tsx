  ...
  const faqs = [
    {
      ...
      a: "Yes! ReelGrab is 100% free with no hidden costs, subscriptions, or premium features. Download unlimited Instagram Reels without paying anything."
    },
    {
    ...
    },
    {
      ...
      a: "ReelGrab downloads videos in the highest quality available from Instagram, including HD and 4K resolution when available."
    },
    {
      q: "Will there be a watermark on downloaded videos?",
      a: "No watermarks! Your downloaded videos will be clean and original without any ReelGrab branding."
    },
    {
    ...
    },
    {
      ...
      a: "You can download public Reels for personal use. Always respect copyright laws and the original creator's rights. Don't re-upload content without permission."
    }
  ];
    ...
    <section id="faq" className="py-20 px-4 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            <div key={i} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-all">
              <button
